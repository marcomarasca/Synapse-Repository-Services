...
public class SqlConstants {
	...
	public static final String TABLE_ACCESS_REQUIREMENT_PROJECTS				= "ACCESS_REQUIREMENT_PROJECT";
	public static final String COL_ACCESS_REQUIREMENT_PROJECT_AR_ID				= "AR_ID";
	public static final String COL_ACCESS_REQUIREMENT_PROJECT_PROJECT_ID		= "PROJECT_ID";
	public static final String COL_ACCESS_REQUIREMENT_PROJECT_SCHEMA			= "schema/AccessRequirementProject-ddl.sql";
	...
	public static final String TABLE_RESOURCE_ACCESS			= "ACL_RESOURCE_ACCESS";
	...
	public static final String TABLE_RESOURCE_ACCESS_TYPE			= "ACL_RESOURCE_ACCESS_TYPE"; 
	...
	public static final String TABLE_TABLE_SNAPSHOT 			= "TABLE_SNAPSHOT";
	public static final String COL_TABLE_SNAPSHOT_ID			= "SNAPSHOT_ID";
	public static final String COL_TABLE_SNAPSHOT_TABLE_ID		= "TABLE_ID";
	public static final String COL_TABLE_SNAPSHOT_VERSION		= "VERSION";
	public static final String COL_TABLE_SNAPSHOT_CREATED_BY	= "CREATED_BY";
	public static final String COL_TABLE_SNAPSHOT_CREATED_ON	= "CREATED_ON";
	public static final String COL_TABLE_SNAPSHOT_BUCKET		= "BUCKET_NAME";
	public static final String COL_TABLE_SNAPSHOT_KEY			= "KEY";
	public static final String DDL_TABLE_SNAPSHOT 				= "schema/TableSnapshot-ddl.sql";
	...
	public static final String COL_TOS_AGREEMENT_CREATED_ON   			= "CREATED_ON";
	public static final String COL_TOS_AGREEMENT_CREATED_BY   			= "CREATED_BY";
	public static final String COL_TOS_AGREEMENT_VERSION   				= "VERSION";
	public static final String DDL_TABLE_TOS_AGREEMENT					= "schema/tos/TermsOfServiceAgreement-ddl.sql";
	...
	// The user OTP secrets mapping table
	public static final String DDL_OTP_SECRET = 										"schema/OtpSecret-ddl.sql";
	public static final String TABLE_OTP_SECRET =	 									"OTP_SECRET";
	public static final String COL_OTP_SECRET_ID = 										"ID";
	public static final String COL_OTP_SECRET_ETAG = 									"ETAG";
	public static final String COL_OTP_SECRET_CREATED_ON = 								"CREATED_ON";
	public static final String COL_OTP_SECRET_PRINCIPAL_ID = 							"PRINCIPAL_ID";
	...
	public static final String TABLE_PROJECT_STORAGE_USAGE = 			"PROJECT_STORAGE_USAGE";
	public static final String COL_PROJECT_STORAGE_USAGE_PROJECT_ID = 	"PROJECT_ID";
	public static final String COL_PROJECT_STORAGE_USAGE_LOCATION_ID =	"STORAGE_LOCATION_ID";
	public static final String COL_PROJECT_STORAGE_USAGE_UPDATED_ON =	"UPDATED_ON";
	public static final String COL_PROJECT_STORAGE_USAGE_SIZE = 		"SIZE_BYTES";
	public static final String DDL_PROJECT_STORAGE_USAGE = 				"schema/statistics/ProjectStorageUsage-ddl.sql";
