...
public class SQLUtils {
	...
	/**
	 * Get the table name to assign to the JSON_TABLE statement for a multi-value table associated with the given table and column.
	 * 
	 * @param idAndVersion
	 * @param columnId
	 * @return
	 */
	public static String getJsonTableNameForMultiValueColumnIndex(IdAndVersion idAndVersion, String columnId){
	 ...
	 * Unnested columns are present in the JSON_TABLE tables with names generated by 
	 * {@link #getJsonTableNameForMultiValueColumnIndex(IdAndVersion, String)}
